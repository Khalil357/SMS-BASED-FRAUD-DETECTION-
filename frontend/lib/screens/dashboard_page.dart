...
class _DashboardPageState extends State<DashboardPage> with WidgetsBindingObserver {
  ...
  /// Asks the user, once, whether blocked numbers should be stopped at the
  /// phone level (not just hidden inside this app). Only relevant on Android —
  /// iOS has no equivalent capability for any app.
  ...
  Future<void> _openHistoryScan() async {
